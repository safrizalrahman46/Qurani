...
import io.qurani.android.databinding.ItemDashboardGeneralBinding
...
class DashboardGeneralSliderAdapter(items: List<MenuItem>, private val activity: MainActivity) :
    io.qurani.android.manager.adapter.BaseArrayAdapter<MenuItem, DashboardGeneralSliderAdapter.ViewHolder>(items),
