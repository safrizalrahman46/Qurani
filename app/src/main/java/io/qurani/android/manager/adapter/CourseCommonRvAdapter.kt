...
import io.qurani.android.databinding.ItemCourseCommonBinding
...
class CourseCommonRvAdapter(items: List<CourseCommonItem>, private val wideClickable: Boolean = false) :
    io.qurani.android.manager.adapter.BaseArrayAdapter<CourseCommonItem, CourseCommonRvAdapter.ViewHolder>(items) {
