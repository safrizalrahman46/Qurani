...
import io.qurani.android.databinding.ItemCommonBinding
...
class TrendingCategoriesRvAdapter(items: List<CommonItem>, private val windowManager: WindowManager) :
    io.qurani.android.manager.adapter.BaseArrayAdapter<CommonItem, TrendingCategoriesRvAdapter.ViewHolder>(items) {
