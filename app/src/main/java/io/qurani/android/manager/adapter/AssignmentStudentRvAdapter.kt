...
import io.qurani.android.databinding.ItemStudentResultBinding
...
class AssignmentStudentRvAdapter(assignments: List<Assignment>) :
    io.qurani.android.manager.adapter.BaseArrayAdapter<Assignment, AssignmentStudentRvAdapter.ViewHolder>(assignments) {
