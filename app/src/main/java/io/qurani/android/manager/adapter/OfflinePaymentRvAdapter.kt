...
import io.qurani.android.databinding.ItemOfflinePaymentBinding
...
class OfflinePaymentRvAdapter(items: List<OfflinePayment>) :
    io.qurani.android.manager.adapter.BaseArrayAdapter<OfflinePayment, OfflinePaymentRvAdapter.ViewHolder>(items) {
