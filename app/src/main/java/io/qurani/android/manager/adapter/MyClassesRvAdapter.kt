...
import io.qurani.android.databinding.ItemMyClassesBinding
...
class MyClassesRvAdapter(items: List<Course>, private val purchased: Boolean = false) :
    io.qurani.android.manager.adapter.BaseArrayAdapter<Course, MyClassesRvAdapter.ViewHolder>(items) {
    ...
    override fun onBindViewHolder(viewholder: ViewHolder, position: Int) {
        ...
        if (course.priceWithDiscount == 0.0) {
            ...
            binding.itemFavoriteCoursePriceTv.text =
                ("${io.qurani.android.manager.App.appConfig.currency.sign}${course.priceWithDiscount}")
        }
