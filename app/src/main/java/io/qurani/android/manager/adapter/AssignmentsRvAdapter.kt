...
import io.qurani.android.databinding.ItemAssignmentBinding
...
class AssignmentsRvAdapter(assigments: List<Assignment>, private val isInstructor: Boolean = false) :
    io.qurani.android.manager.adapter.BaseArrayAdapter<Assignment, AssignmentsRvAdapter.ViewHolder>(assigments) {
