...
import io.qurani.android.databinding.ItemQuizAnswerBinding
import io.qurani.android.manager.Utils.toBoolean
import io.qurani.android.model.QuizQuestionAnswer
...
class QuizQuestionAnswerRvAdapter(
    ...
    io.qurani.android.manager.adapter.BaseArrayAdapter<QuizQuestionAnswer, QuizQuestionAnswerRvAdapter.ViewHolder>(answers) {
