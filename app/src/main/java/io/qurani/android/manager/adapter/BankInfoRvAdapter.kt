...
import io.qurani.android.databinding.ItemBankInfoBinding
import io.qurani.android.model.SystemBankAccount

class BankInfoRvAdapter(info: List<SystemBankAccount>) :
    io.qurani.android.manager.adapter.BaseArrayAdapter<SystemBankAccount, BankInfoRvAdapter.ViewHolder>(info) {
