...
object ApiService {
    ...
    val downloadingRequestsResponses: HashMap<Int, io.qurani.android.manager.net.ProgressResponseBody> = HashMap()
    ...
    private fun getOkHttpDownloadClientBuilder(
        ...
        httpClientBuilder.connectTimeout(200, TimeUnit.SECONDS)
        httpClientBuilder.writeTimeout(200, TimeUnit.SECONDS)
        ...
        httpClientBuilder.addInterceptor(Interceptor { chain: Interceptor.Chain ->
            ...
            val progressResponseBody =
                io.qurani.android.manager.net.ProgressResponseBody(
            ...
            OkHttpClient.Builder().addInterceptor(interceptor).addInterceptor(
                Interceptor { chain: Interceptor.Chain ->
                    ...
                    if (rsp.code == 401 && activity != null) {
                        io.qurani.android.manager.App.logout(activity!!)
                    }
                    rsp
                }
            )
