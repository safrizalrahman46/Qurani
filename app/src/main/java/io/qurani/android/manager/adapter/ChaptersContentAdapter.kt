...
class ChaptersContentAdapter(
    ...
    private fun getNextFragFromCourse(item: CourseCommonItem, flatPosition: Int): Fragment {
        ...
        bundle.putInt(io.qurani.android.manager.App.CHAPTER_POSITION, listPos.groupPos)
        bundle.putInt(io.qurani.android.manager.App.CHAPTER_ITEM_POSITION, listPos.childPos)
