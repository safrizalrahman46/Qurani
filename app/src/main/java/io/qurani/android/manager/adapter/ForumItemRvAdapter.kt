...
import io.qurani.android.databinding.ItemForumBinding
...
class ForumItemRvAdapter(
    ...
    io.qurani.android.manager.adapter.BaseArrayAdapter<ForumItem, ForumItemRvAdapter.ViewHolder>(forumItems) {
