...
import io.qurani.android.databinding.ItemPricingPlanBinding
...
class PricingPlanRvAdapter(
    ...
    io.qurani.android.manager.adapter.BaseArrayAdapter<PricingPlan, PricingPlanRvAdapter.ViewHolder>(pricingPlans) {
    ...
    inner class ViewHolder(val binding: ItemPricingPlanBinding) :
        ...
        override fun onClick(v: View?) {
            ...
            if (plan.isPointsItem && io.qurani.android.manager.App.quickInfo!!.availablePoints < coursePoints!!) {
                ToastMaker.show(
                    context,
