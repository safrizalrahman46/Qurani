...
interface ApiClient {
    ...
    @POST("login")
    fun login(@Body login: Login): Call<Data<io.qurani.android.model.Response>>
    ...
    fun registerUser(@Body user: User): Call<Data<io.qurani.android.model.Response>>

    @Headers("Content-Type: application/json")
    @POST("google/callback")
    fun registerWithGoogle(@Body thirdPartyLogin: ThirdPartyLogin): Call<Data<io.qurani.android.model.Response>>

    @Headers("Content-Type: application/json")
    @POST("facebook/callback")
    fun registerWithFacebook(@Body thirdPartyLogin: ThirdPartyLogin): Call<Data<io.qurani.android.model.Response>>
    ...
    @Headers("Content-Type: application/json")
    @POST("panel/comments")
    fun comment(@Body comment: Comment): Call<io.qurani.android.model.BaseResponse>

    @Headers("Content-Type: application/json")
    @POST("panel/comments/{comment_id}/reply")
    fun reply(@Path("comment_id") commentId: Int, @Body comment: Comment): Call<io.qurani.android.model.BaseResponse>
    ...
    ): Call<io.qurani.android.model.BaseResponse>

    @Headers("Content-Type: application/json")
    @PUT("panel/comments/{comment_id}")
    fun editComment(@Path("comment_id") commentId: Int, @Body comment: Comment): Call<io.qurani.android.model.BaseResponse>
    ...
    fun removeComment(@Path("comment_id") commentId: Int): Call<io.qurani.android.model.BaseResponse>
    ...
    fun changePassword(@Body changePassword: ChangePassword): Call<Data<io.qurani.android.model.Response>>

    @Headers("Content-Type: application/json")
    @PUT("panel/profile-setting")
    fun changeProfileSettings(@Body changeSettings: UserChangeSettings): Call<io.qurani.android.model.BaseResponse>

    @PUT("panel/profile-setting")
    fun changeProfileSettings(@Body financialSettings: FinancialSettings): Call<io.qurani.android.model.BaseResponse>

    @PUT("panel/profile-setting")
    fun changeProfileSettings(@Body changeSettings: UserChangeLocalization): Call<io.qurani.android.model.BaseResponse>

    @Multipart
    @POST("panel/profile-setting/images")
    fun changeProfileImage(@Part file: MultipartBody.Part): Call<io.qurani.android.model.BaseResponse>
    ...
    fun finishMeeting(@Path("meeting_id") meetingId: Int, @Body any: Any): Call<io.qurani.android.model.BaseResponse>

    @Headers("Content-Type: application/json")
    @POST("instructor/meetings/create-link")
    fun createJoinForMeeting(@Body reserveMeeting: ReserveMeeting): Call<io.qurani.android.model.BaseResponse>
    ...
    fun followUser(@Path("user_id") userId: Int, @Body follow: Follow): Call<io.qurani.android.model.BaseResponse>
    ...
    fun reserveMeeting(@Body reserveMeeting: ReserveTimeMeeting): Call<io.qurani.android.model.BaseResponse>
    ...
    fun setNotifStatusToSeen(@Path("id") notifId: Int): Call<io.qurani.android.model.BaseResponse>
    ...
    @Headers("Content-Type: application/json")
    @POST("panel/support")
    fun addTicket(@Body ticket: Ticket): Call<io.qurani.android.model.BaseResponse>
    ...
    ): Call<Data<io.qurani.android.model.Response>>
    ...
    fun closeTicket(@Path("id") ticketId: Int): Call<io.qurani.android.model.BaseResponse>
    ...
    fun requestPayout(@Body any: Any): Call<io.qurani.android.model.BaseResponse>
    ...
    fun addOfflinePayments(@Body offlinePayment: OfflinePayment): Call<io.qurani.android.model.BaseResponse>
    ...
    fun addRemoveFromFavorite(@Body addToFav: AddToFav): Call<io.qurani.android.model.BaseResponse>
    ...
    fun removeFromCart(@Path("id") cartItemId: Int): Call<io.qurani.android.model.BaseResponse>
    ...
    fun checkout(@Body coupon: Coupon?): Call<Data<io.qurani.android.model.Response>>

    @Headers("Content-Type: application/json")
    @POST("users/{user_id}/send-message")
    fun addNewMessage(@Path("user_id") userId: Int, @Body message: Message): Call<io.qurani.android.model.BaseResponse>

    @Headers("Content-Type: application/json")
    @POST("courses/{course_id}/report")
    fun reportCourse(@Path("course_id") courseId: Int, @Body comment: Comment): Call<io.qurani.android.model.BaseResponse>

    @Headers("Content-Type: application/json")
    @POST("panel/reviews3")
    fun addCourseReview(@Body review: Review): Call<io.qurani.android.model.BaseResponse>

    @Headers("Content-Type: application/json")
    @POST("panel/cart")
    fun addToCart(@Body addToCart: AddToCart): Call<io.qurani.android.model.BaseResponse>
    ...
    fun subscribe(@Body addToCart: AddToCart): Call<io.qurani.android.model.BaseResponse>
    ...
    fun chargeAccount(@Body paymentRequest: PaymentRequest): Call<Data<io.qurani.android.model.Response>>

    @Headers("Content-Type: application/json")
    @POST("panel/payments/credit")
    fun payWithCredit(@Body paymentRequest: PaymentRequest): Call<io.qurani.android.model.BaseResponse>

    @Headers("Content-Type: application/json")
    @POST("panel/subscribe/web_pay")
    fun checkoutSubscription(@Body subscriptionItem: SubscriptionItem): Call<Data<io.qurani.android.model.Response>>
    ...
    fun addFreeCourse(@Path("course_id") courseId: Int): Call<io.qurani.android.model.BaseResponse>
    ...
    fun sendChangePasswordLink(@Body forgetPassword: ForgetPassword): Call<io.qurani.android.model.BaseResponse>

    @GET("blogs/categories")
    fun getBlogCategories(): Call<Data<List<Category>>>

    @POST("logout")
    fun logout(@Body follow: Follow): Call<io.qurani.android.model.BaseResponse>
    ...
    fun checkoutSaasPackage(@Body saasPackageItem: SaasPackageItem): Call<Data<io.qurani.android.model.Response>>
    ...
    fun pinForumItem(@Path("id") id: Int, @Body follow: Follow): Call<io.qurani.android.model.BaseResponse>

    @POST("panel/webinars/forums/answers/{id}/pin")
    fun pinForumItemAnswer(@Path("id") id: Int, @Body follow: Follow): Call<io.qurani.android.model.BaseResponse>

    @POST("panel/webinars/forums/answers/{id}/resolve")
    fun markAnswerAsResolved(@Path("id") id: Int, @Body follow: Follow): Call<io.qurani.android.model.BaseResponse>
    ...
    fun replyToForumQuestion(@Path("id") id: Int, @Body reply: Reply): Call<io.qurani.android.model.BaseResponse>

    @PUT("panel/webinars/forums/answers/{id}")
    fun editReplyToForumQuestion(@Path("id") id: Int, @Body reply: Reply): Call<io.qurani.android.model.BaseResponse>
