...
import io.qurani.android.databinding.ItemSubscriptionBinding
...
class SubscriptionSliderAdapter(
    ...
    io.qurani.android.manager.adapter.BaseArrayAdapter<SubscriptionItem, SubscriptionSliderAdapter.ViewHolder>(items) {
