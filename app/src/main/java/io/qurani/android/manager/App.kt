...
class App : Application() {
    ...
    companion object {
        ...
        fun showExitDialog(activity: AppCompatActivity) {
            val bundle = Bundle()
            bundle.putString(io.qurani.android.manager.App.Companion.TITLE, activity.getString(R.string.exit))
            bundle.putString(io.qurani.android.manager.App.Companion.TEXT, activity.getString(R.string.exit_desc))
        ...
        fun initHeader(statusBar: View) {
            val statusBarHeight =
                io.qurani.android.manager.App.Companion.statusBarHeight(statusBar.context)
            statusBar.post {
        ...
        fun isLoggedIn(): Boolean {
            return io.qurani.android.manager.App.Companion.loggedInUser != null
        }
        ...
        fun getShapeFromColor(view: View, color: Int, currentCorners: Float = 0f): ViewShape {
            ...
            topShape.currentCorners =
                io.qurani.android.manager.Utils.changeDpToPx(view.context, currentCorners)
            return topShape
        }
        ...
        fun logout(activity: MainActivity) {
            ...
            io.qurani.android.manager.App.Companion.loggedInUser = null
            io.qurani.android.manager.App.Companion.quickInfo = null
