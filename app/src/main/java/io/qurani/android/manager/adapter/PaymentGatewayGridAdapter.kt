...
import io.qurani.android.databinding.ItemGatewayGridBinding
import io.qurani.android.manager.Utils
import io.qurani.android.model.PaymentChannel
...
class PaymentGatewayGridAdapter(
    ...
    io.qurani.android.manager.adapter.BaseArrayAdapter<PaymentChannel, PaymentGatewayGridAdapter.ViewHolder>(items) {
