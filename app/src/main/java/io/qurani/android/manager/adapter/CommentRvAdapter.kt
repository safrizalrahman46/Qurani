...
import io.qurani.android.databinding.ItemCommentBinding
...
import io.qurani.android.ui.widget.CommentMoreDialog
...
class CommentRvAdapter(
    ...
    io.qurani.android.manager.adapter.BaseArrayAdapter<Comment, CommentRvAdapter.ViewHolder>(comments) {
    ...
    inner class ViewHolder(val binding: ItemCommentBinding) :
        ...
        override fun onClick(v: View?) {
            ...
            val bundle = Bundle()
            bundle.putParcelable(io.qurani.android.manager.App.COMMENT, items[bindingAdapterPosition])
