...
import io.qurani.android.databinding.ItemSalesBinding
import io.qurani.android.manager.Utils
import io.qurani.android.model.SalesItem

class SalesRvAdapter(sales: List<SalesItem>) :
    io.qurani.android.manager.adapter.BaseArrayAdapter<SalesItem, SalesRvAdapter.ViewHolder>(sales) {
