...
import io.qurani.android.databinding.ItemFeaturedCourseBinding
import io.qurani.android.manager.App
import io.qurani.android.manager.Utils
import io.qurani.android.model.Course
import io.qurani.android.model.PrerequisiteCourse
...
class FeaturedSliderAdapter<T>(items: List<T>, private val activity: MainActivity) :
    io.qurani.android.manager.adapter.BaseArrayAdapter<T, FeaturedSliderAdapter<T>.ViewHolder>(items) {
