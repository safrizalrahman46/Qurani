package io.qurani.android.presenter
...
class Presenter {
    ...
    interface CommonApiPresenter {
        ...
        fun addToCart(addToCart: AddToCart, callback: ItemCallback<io.qurani.android.model.BaseResponse>)
    ...
    interface CourseChapterItemPresenter {
        ...
        fun downloadFile(file: ChapterFileItem, progressListener: io.qurani.android.manager.net.OnDownloadProgressListener)
