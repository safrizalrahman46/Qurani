...
import io.qurani.android.databinding.DialogProvidersFiltersBinding
...
import io.qurani.android.presenterImpl.ProvidersFiltersPresenterImpl

class ProvidersFiltersDialog : io.qurani.android.manager.net.observer.NetworkObserverBottomSheetDialog(), View.OnClickListener {
    ...
    private fun init() {
        ...
        val list = requireArguments().getParcelableArrayList<KeyValuePair>(io.qurani.android.manager.App.SELECTED)
        if (list != null) {
            mSelectedList = list
    ...
    fun onCategoriesRecevied(data: Data<Count<Category>>) {
        ...
        for (category in cats) {
            ...
            val drawable = ChipDrawable.createFromAttributes(
                ...
                com.rajat.pdfviewer.R.style.Widget_MaterialComponents_Chip_Choice
            )
