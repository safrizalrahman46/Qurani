...
import io.qurani.android.databinding.FragHomeBinding
import io.qurani.android.manager.App
import io.qurani.android.manager.adapter.HomeClassRvAdapter
...
import io.qurani.android.model.QuickInfo
import io.qurani.android.presenter.Presenter
import io.qurani.android.presenterImpl.CommonApiPresenterImpl
import io.qurani.android.presenterImpl.HomePresenterImpl
import io.qurani.android.ui.MainActivity
import io.qurani.android.ui.widget.CustomScrollView
import kotlin.math.abs


class HomeFrag : io.qurani.android.manager.net.observer.NetworkObserverFragment(), ViewTreeObserver.OnScrollChangedListener,
    ...
    private val mQuickInfoCallback = object : ItemCallback<QuickInfo> {
        override fun onItem(info: QuickInfo, vararg args: Any) {
            ...
            io.qurani.android.manager.App.quickInfo = info
    ...
    private val mViewAllBtnListener = View.OnClickListener { v ->
        ...
        val bundle = Bundle()
        bundle.putString(io.qurani.android.manager.App.TITLE, title)
        if (bundles != null) {
            bundle.putParcelableArrayList(io.qurani.android.manager.App.COURSES, bundles)
        }else{
            bundle.putSerializable(io.qurani.android.manager.App.FILTERS, map)
        }
    ...
    private fun init() {
        (activity as MainActivity).hideToolbar(
            io.qurani.android.manager.App.getShapeFromColor(
...
//        App.initHeader(mBinding.homeStatusBar)
    ...
    fun initUserInfo() {
        if (io.qurani.android.manager.App.isLoggedIn()) {
            val name = (getString(R.string.hi) + " " + io.qurani.android.manager.App.loggedInUser!!.name + "\uD83D\uDC4B")
