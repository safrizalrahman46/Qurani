...
class ErrorFrag : Fragment(), View.OnClickListener {
    ...
    companion object {
        private val mRetryListeners = ArrayDeque<io.qurani.android.manager.net.RetryListener>()
    ...
    private fun init() {
        ...
        if (arguments != null && requireArguments().getBoolean(io.qurani.android.manager.App.COURSES)) {
    ...
    fun addOnRetryListener(retryListener: io.qurani.android.manager.net.RetryListener?) {
