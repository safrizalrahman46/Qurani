...
import io.qurani.android.databinding.DialogReviewBinding
...
import io.qurani.android.presenterImpl.CourseReviewPresenterImpl

class CourseReviewDialog : io.qurani.android.manager.net.observer.NetworkObserverBottomSheetDialog(), View.OnClickListener {
    ...
    private fun init() {
        mReview = requireArguments().getParcelable(io.qurani.android.manager.App.ITEM)!!
    ...
    fun onReviewSaved(response: io.qurani.android.model.BaseResponse, review: Review) {
