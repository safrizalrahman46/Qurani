...
import io.qurani.android.presenterImpl.ReplyToCourseForumPresenterImpl

class ForumReplyDialog : io.qurani.android.manager.net.observer.NetworkObserverBottomSheetDialog(), View.OnClickListener {
    ...
    fun onRsp(response: io.qurani.android.model.BaseResponse) {
