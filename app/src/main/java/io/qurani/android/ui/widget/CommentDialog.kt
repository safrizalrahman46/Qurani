...
import io.qurani.android.databinding.DialogBaseInputBinding
...
import io.qurani.android.presenterImpl.ReportReplyCommentPresenterImpl
import java.io.Serializable

class CommentDialog : io.qurani.android.manager.net.observer.NetworkObserverBottomSheetDialog(), View.OnClickListener {
    ...
    private fun init() {
        ...
        mItem = requireArguments().getString(io.qurani.android.manager.App.ITEM)
        mId = requireArguments().getInt(io.qurani.android.manager.App.ID)
        ...
        when (mType) {
            ...
            Type.EDIT -> {
                val comment = requireArguments().getParcelable<Comment>(io.qurani.android.manager.App.COMMENT)!!
