...
import io.qurani.android.databinding.DialogCourseFiltersBinding
...
import io.qurani.android.model.CourseFilter
import io.qurani.android.model.CourseFilterOption
import io.qurani.android.model.KeyValuePair
import java.util.*
import kotlin.collections.ArrayList
import kotlin.math.roundToInt

class ClassesFiltersDialog : io.qurani.android.manager.net.observer.NetworkObserverBottomSheetDialog(), View.OnClickListener {
    ...
    private fun init() {
        ...
        val filters = requireArguments().getParcelableArrayList<CourseFilter>(io.qurani.android.manager.App.FILTERS)!!
        val selected = requireArguments().getParcelableArrayList<KeyValuePair>(io.qurani.android.manager.App.SELECTED)
