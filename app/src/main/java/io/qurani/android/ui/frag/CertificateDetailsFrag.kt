...
import io.qurani.android.databinding.FragCertificateDetailsBinding
...
import io.qurani.android.manager.adapter.StudentRvAdapter
...
import io.qurani.android.presenterImpl.CertificateDetailsPresenterImpl
import io.qurani.android.ui.MainActivity
import io.qurani.android.ui.widget.ProgressiveLoadingDialog
import java.io.File
import java.lang.Exception

class CertificateDetailsFrag : io.qurani.android.manager.net.observer.NetworkObserverFragment(), View.OnClickListener {
    ...
    private fun init() {
        ...
        when (val parcelable: Any = requireArguments().getParcelable(io.qurani.android.manager.App.CERTIFICATE)!!) {
            is QuizResult -> {
                mResult = parcelable
                mQuiz = mResult!!.quiz
    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            ...
            R.id.certificateDetailsLatestStdViewAllBtn -> {
                val bundle = Bundle()
                bundle.putParcelableArrayList(io.qurani.android.manager.App.RESULT, mCertStudents)
    ...
    private fun downloadCert(
        ...
        bundle.putString(io.qurani.android.manager.App.URL, downloadUrl)
        bundle.putBoolean(io.qurani.android.manager.App.FILE_NAME_FROM_HEADER, fileNameFromHeader)
        bundle.putString(io.qurani.android.manager.App.DIR, io.qurani.android.manager.App.Companion.Directory.CERTIFICATE.value())
        bundle.putBoolean(io.qurani.android.manager.App.TO_DOWNLOADS, toDownloads)
        bundle.putString(io.qurani.android.manager.App.DEFAULT_FILE_NAME, defaultFileName)
