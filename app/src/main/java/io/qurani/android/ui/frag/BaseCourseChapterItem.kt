...
import io.qurani.android.databinding.FragCourseChapterItemBinding
...
import io.qurani.android.manager.adapter.CourseCommonRvAdapter
...
import io.qurani.android.manager.player.VimeoVideoPlayerHelper
import io.qurani.android.manager.player.YoutubeVideoPlayerHelper
import io.qurani.android.model.*
import io.qurani.android.presenter.Presenter
import io.qurani.android.presenterImpl.CourseChapterItemPresenterImpl
...
import io.qurani.android.ui.WebViewActivity
...
abstract class BaseCourseChapterItem : io.qurani.android.manager.net.observer.NetworkObserverFragment(), View.OnClickListener,
    PlayerHelper.Listener, CompoundButton.OnCheckedChangeListener,
    ...
    protected fun initFileItem() {
        ...
        if ((mFileItem!!.storage == ChapterFileItem.Storage.UPLOAD.value && mFileItem!!.fileType.uppercase(
            ...
            initOnlineVideoConf()
                ...
                Locale.ENGLISH
            ) == ChapterFileItem.PDF_FILE_TYPE &&
            (mFileItem!!.storage == ChapterFileItem.Storage.S3.value ||
                    mFileItem!!.storage == ChapterFileItem.Storage.UPLOAD.value)
        ) {
    ...
    private fun getFileFromLocalDir(): File? {
        if (mFileItem!!.storage == ChapterFileItem.Storage.UPLOAD.value) {
            ...
            val videoFile = File(
                ...
                "${io.qurani.android.manager.App.Companion.Directory.DOWNLOADS.value()}${File.separator}$fileName"
            )
                ...
                when ((v as Button).text.toString()) {
                    ...
                    getString(R.string.join) -> {
                        if (mSessionItem!!.sessionApi == ChapterSessionItem.SessionApiType.AGORA.value) {
                            ...
                            intent.putExtra(io.qurani.android.manager.App.URL, mSessionItem!!.joinLink)
                    ...
                    getString(R.string.play), getString(R.string.view) -> {
                        ...
                        if (mFileItem!!.interactiveFilePath != null) {
                            intent.putExtra(io.qurani.android.manager.App.URL, mFileItem!!.interactiveFilePath)
                        } else {
                            intent.putExtra(io.qurani.android.manager.App.URL, mFileItem!!.file)
                        }
                        startActivity(intent)
                    }
    ...
    private fun cancelDownload() {
        ...
        val bundle = Bundle()
        bundle.putString(io.qurani.android.manager.App.TITLE, getString(R.string.cancel_download))
        bundle.putString(io.qurani.android.manager.App.TEXT, getString(R.string.cancel_download_desc))
    ...
    fun onItemStatusChanged(
        res: io.qurani.android.model.BaseResponse,
