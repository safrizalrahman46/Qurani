...
import io.qurani.android.manager.adapter.CertificateRvAdapter
...
import io.qurani.android.model.Certificate
...
import io.qurani.android.presenterImpl.CertificatesPresenterImpl
import io.qurani.android.ui.MainActivity
import io.qurani.android.ui.frag.abs.EmptyState

class CertificatesFrag : io.qurani.android.manager.net.observer.NetworkObserverFragment(),
    ...
    private fun init() {
        ...
        val type = requireArguments().getSerializable(io.qurani.android.manager.App.TYPE) as Certificate.Type
    ...
    override fun onClick(view: View?, position: Int, id: Int) {
        ...
        val bundle = Bundle()
        bundle.putParcelable(io.qurani.android.manager.App.CERTIFICATE, certificate)
