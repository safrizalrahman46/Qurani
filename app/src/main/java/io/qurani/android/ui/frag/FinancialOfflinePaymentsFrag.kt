...
import io.qurani.android.manager.adapter.OfflinePaymentRvAdapter
...
import io.qurani.android.presenterImpl.FinancialOfflinePaymentsPresenterImpl
import io.qurani.android.ui.frag.abs.EmptyState

class FinancialOfflinePaymentsFrag : io.qurani.android.manager.net.observer.NetworkObserverFragment(), EmptyState {
