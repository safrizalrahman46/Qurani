...
import io.qurani.android.databinding.FragProfileAboutBinding
...
import io.qurani.android.presenterImpl.ProfileAboutPresenterImpl
...
class ProfileAboutFrag : Fragment(), EmptyState, MainActivity.OnRefreshListener {
    ...
    private fun init() {
        ...
        mUserProfile = requireArguments().getParcelable(io.qurani.android.manager.App.USER)!!
    ...
    override fun refresh() {
        hideEmptyState()
        mUserProfile = io.qurani.android.manager.App.loggedInUser!!
        init()
    }
