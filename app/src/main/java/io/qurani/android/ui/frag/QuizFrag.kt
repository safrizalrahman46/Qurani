...
import io.qurani.android.databinding.FragQuizBinding
import io.qurani.android.manager.App
import io.qurani.android.manager.ToastMaker
import io.qurani.android.manager.Utils
import io.qurani.android.manager.adapter.QuizQuestionAnswerRvAdapter
import io.qurani.android.model.*
import io.qurani.android.presenter.Presenter
import io.qurani.android.presenterImpl.QuizPresenterImpl
...
class QuizFrag : Fragment(), View.OnClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        io.qurani.android.manager.App.currentFrag = this
        init()
    }

    override fun onDestroy() {
        super.onDestroy()
        io.qurani.android.manager.App.currentFrag = null
    }

    private fun init() {
        (activity as MainActivity).hideToolbar()

        mResult = requireArguments().getParcelable(io.qurani.android.manager.App.RESULT)!!
        mPresenter = QuizPresenterImpl(this)

        io.qurani.android.manager.App.initHeader(mBinding.quizStatusbar)
...
//        }
    ...
    private fun showExitQuizConfirmation() {
        ...
        val bundle = Bundle()
        bundle.putString(io.qurani.android.manager.App.TITLE, getString(R.string.finish))
        bundle.putString(io.qurani.android.manager.App.TEXT, getString(R.string.finish_quiz_desc))
    ...
    fun onQuizResultSaved(data: Data<Data<QuizResult>>) {
        ...
        if (data.isSuccessful) {
            val bundle = Bundle()
            bundle.putParcelable(io.qurani.android.manager.App.RESULT, data.data!!.data)
