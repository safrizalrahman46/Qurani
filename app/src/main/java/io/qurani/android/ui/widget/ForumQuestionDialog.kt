...
import io.qurani.android.manager.UriToPath
...
import io.qurani.android.presenterImpl.ForumQuestionPresenterImpl
import java.io.File


class ForumQuestionDialog : io.qurani.android.manager.net.observer.NetworkObserverBottomSheetDialog(), View.OnClickListener {
    ...
    private fun init() {
        ...
        mCourseId = requireArguments().getInt(io.qurani.android.manager.App.ID)
