...
import io.qurani.android.databinding.DialogMeetingDetailsMoreBinding
...
import io.qurani.android.presenterImpl.MeetingDetailsMorePresenterImpl
import java.util.*


class MeetingDetailsMoreDialog : io.qurani.android.manager.net.observer.NetworkObserverBottomSheetDialog(), View.OnClickListener {
    ...
    private fun init() {
        ...
        mMetting = requireArguments().getParcelable(io.qurani.android.manager.App.MEETING)!!
    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            ...
            R.id.meetingDetailsMoreFinishMeetingTv -> {
                ...
                bundle.putString(io.qurani.android.manager.App.TEXT, getString(R.string.finish_meeting_desc))
    ...
    fun onMeetingFinished(response: io.qurani.android.model.BaseResponse) {
