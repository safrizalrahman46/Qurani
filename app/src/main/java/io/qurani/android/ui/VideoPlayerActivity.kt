...
import io.qurani.android.databinding.ActivityVideoPlayerBinding
...
//                    View.SYSTEM_UI_FLAG_HIDE_NAVIGATION
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val requestLandscape = intent.getBooleanExtra(io.qurani.android.manager.App.REQUEST_LANDSCAPE, false)
        if (requestLandscape) {
