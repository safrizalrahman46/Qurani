...
import io.qurani.android.databinding.FragSignInBinding
...
import io.qurani.android.presenterImpl.SignInPresenterImpl
    ...
    override fun onClick(v: View?) {
        ...
        when (v?.id) {
            ...
            R.id.signInSignUpBtn -> {
                val bundle = Bundle()
                bundle.putBoolean(io.qurani.android.manager.App.REQUEDT_TO_LOGIN_FROM_INSIDE_APP, mSignInRequest)
...
//    }
    ...
    fun onSuccessfulLogin(response: Data<io.qurani.android.model.Response>) {
        if (response.isSuccessful) {
