...
import io.qurani.android.databinding.FragAssignmentOverviewBinding
import io.qurani.android.manager.App
import io.qurani.android.manager.ToastMaker
import io.qurani.android.manager.Utils
import io.qurani.android.manager.adapter.AttachmentRvAdapter
...
import io.qurani.android.presenterImpl.AssignmentOverviewPresenterImpl
...
class AssignmentOverviewFrag : io.qurani.android.manager.net.observer.NetworkObserverFragment(), View.OnClickListener,
    ...
    private fun init() {
        initToolbar()
        val assignment = requireArguments().getParcelable<Assignment>(io.qurani.android.manager.App.ITEM)
        val id = requireArguments().getInt(io.qurani.android.manager.App.ID)
    ...
    override fun onClick(v: View?) {
        ...
        val frag = if (mIsInstructorType) {
            bundle.putParcelableArrayList(io.qurani.android.manager.App.ITEMS, mAssignmentStudents)
    ...
    private fun downloadAttachment(attachment: Attachment) {
        ...
        bundle.putString(io.qurani.android.manager.App.URL, attachment.url)
        bundle.putString(io.qurani.android.manager.App.DIR, io.qurani.android.manager.App.Companion.Directory.DOWNLOADS.value())
