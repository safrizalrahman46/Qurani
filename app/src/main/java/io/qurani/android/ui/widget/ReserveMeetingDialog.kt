...
import io.qurani.android.databinding.DialogReserveMeetingBinding
...
import io.qurani.android.presenterImpl.ReserveMeetingDialogPresenterImpl
...
class ReserveMeetingDialog : io.qurani.android.manager.net.observer.NetworkObserverBottomSheetDialog(), View.OnClickListener {
    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            ...
            R.id.reserveMeetingDialogAddBtn -> {
                ...
                val bundle = Bundle()
                bundle.putParcelable(io.qurani.android.manager.App.MEETING, reserveMeeting)
