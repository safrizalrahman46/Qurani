...
import io.qurani.android.model.ChapterFileItem
import io.qurani.android.model.ChapterSessionItem
import io.qurani.android.model.ChapterTextItem
...
class OfflineCourseChapterItemFrag : BaseCourseChapterItem() {
    ...
    private fun init() {
        mChapterPosition = requireArguments().getInt(io.qurani.android.manager.App.CHAPTER_POSITION)
        mChapterItemPosition = requireArguments().getInt(io.qurani.android.manager.App.CHAPTER_ITEM_POSITION)
        ...
        when (val chapterItem = requireArguments().getParcelable<Parcelable>(io.qurani.android.manager.App.ITEM)!!) {
