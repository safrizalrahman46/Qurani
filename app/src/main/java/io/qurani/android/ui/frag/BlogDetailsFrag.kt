...
import io.qurani.android.databinding.FragBlogDetailsBinding
import io.qurani.android.manager.App
import io.qurani.android.manager.ToastMaker
import io.qurani.android.manager.Utils
import io.qurani.android.manager.adapter.CommentRvAdapter
...
class BlogDetailsFrag : Fragment(), View.OnClickListener {
    ...
    private fun init() {
        ...
        mBlog = requireArguments().getParcelable(io.qurani.android.manager.App.BLOG)!!
    ...
    private fun comment() {
        ...
        val bundle = Bundle()
        bundle.putSerializable(io.qurani.android.manager.App.SELECTION_TYPE, CommentDialog.Type.COMMENT_BLOG)
        bundle.putInt(io.qurani.android.manager.App.ID, mBlog.id)
        bundle.putString(io.qurani.android.manager.App.ITEM, io.qurani.android.manager.App.Companion.ItemType.BLOG.value)
