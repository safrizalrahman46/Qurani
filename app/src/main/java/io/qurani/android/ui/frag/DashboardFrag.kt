...
import io.qurani.android.databinding.FragDashboardBinding
import io.qurani.android.manager.App
import io.qurani.android.manager.Utils
import io.qurani.android.manager.adapter.NoticeBoardSliderAdapter
import io.qurani.android.manager.adapter.CardStatisticsRvAdapter
import io.qurani.android.manager.adapter.DashboardGeneralSliderAdapter
...
import io.qurani.android.ui.widget.CustomXAxisRenderer
...
//        App.initHeader(mBinding.dashboardStatusBar)
    ...
    private fun initChart() {
        ...
        dashboardCubicChart.setXAxisRenderer(
            io.qurani.android.ui.widget.CustomXAxisRenderer(
...
//        chart.onChartGestureListener = this
    ...
    private fun addGeneralSlider(info: QuickInfo) {
        ...
        if (info.badges?.nextBadge != null && !io.qurani.android.manager.App.loggedInUser!!.isUser()) {
            menuItem = MenuItem()
    ...
    class CustomMarkerView(context: Context) :
        ...
        override fun refreshContent(
            ...
            if (io.qurani.android.manager.App.loggedInUser!!.isUser()) {
                ...
                chartMarkerTv.text =
                    (io.qurani.android.manager.App.appConfig.currency.sign + e.y.toString()) // set the entry-value as the display text
            }
