...
import io.qurani.android.databinding.DialogAppBinding
...
class AppDialog : DialogFragment(), View.OnClickListener {
    ...
    override fun onViewCreated(
        ...
        val desc = requireArguments().getString(io.qurani.android.manager.App.TEXT)
        val img = requireArguments().getString(io.qurani.android.manager.App.IMG, null)
        val button = requireArguments().getString(io.qurani.android.manager.App.BUTTON, null)
