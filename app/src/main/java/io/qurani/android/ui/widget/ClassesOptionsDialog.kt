...
import io.qurani.android.databinding.DialogCourseOptionsBinding
...
class ClassesOptionsDialog : io.qurani.android.manager.net.observer.NetworkObserverBottomSheetDialog(), View.OnClickListener {
    ...
    private fun init() {
        ...
        val selectedList = requireArguments().getParcelableArrayList<KeyValuePair>(io.qurani.android.manager.App.SELECTED)
