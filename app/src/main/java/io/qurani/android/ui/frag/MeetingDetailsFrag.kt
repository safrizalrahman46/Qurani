...
import io.qurani.android.databinding.FragMeetingDetailsBinding
...
import io.qurani.android.ui.widget.MeetingJoinDetailsDialog
...
class MeetingDetailsFrag : Fragment(), View.OnClickListener {
    ...
    private fun init() {
        ...
        mIsForInstructor = requireArguments().getBoolean(io.qurani.android.manager.App.INSTRUCTOR_TYPE, false)
    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            ...
            R.id.meetingDetailsMoreBtn -> {
                val bundle = Bundle()
                bundle.putParcelable(io.qurani.android.manager.App.MEETING, mMeeting)

                val dialog: io.qurani.android.manager.net.observer.NetworkObserverBottomSheetDialog = if (mIsForInstructor) {
