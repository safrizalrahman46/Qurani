...
import io.qurani.android.manager.adapter.MyCommentRvAdapter
...
class MyCommentsFrag : Fragment(), io.qurani.android.manager.listener.OnItemClickListener, ItemCallback<Comments>, EmptyState {
