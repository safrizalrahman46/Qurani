...
import io.qurani.android.databinding.FragQuizReviewBinding
...
import io.qurani.android.presenterImpl.QuizReviewPresenterImpl
...
//        App.initHeader(mBinding.quizReviewStatusbar)
    ...
    fun onResultStored(response: io.qurani.android.model.BaseResponse) {
