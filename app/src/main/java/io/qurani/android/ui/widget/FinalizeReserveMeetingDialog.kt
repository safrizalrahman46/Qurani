...
import io.qurani.android.databinding.DialogFinalizeReserveMeetingBinding
...
import io.qurani.android.presenterImpl.FinalizeReserveMeetingPresenterImpl
import kotlin.math.roundToInt


class FinalizeReserveMeetingDialog : io.qurani.android.manager.net.observer.NetworkObserverBottomSheetDialog(), View.OnClickListener,
    ...
    private var mConductionType: String? = null
    private var mMeetingType: String? = null
    ...
    private fun init() {
        mMeetingTimeReserve = requireArguments().getParcelable(io.qurani.android.manager.App.MEETING)!!
        ...
        val symbol = io.qurani.android.manager.App.appConfig.currency.sign
        ...
        mBinding.finalizeReserveMeetingOnlinePriceTv.text =
            if (meeting.onlinePriceWithDiscount > 0.0)
                ...
                ) else Utils.formatPrice(requireContext(), meeting.onlinePrice)
    ...
    fun onMeetingReserved(response: io.qurani.android.model.BaseResponse) {
    ...
    private fun updatePrice() {
        ...
        val btnText =
            "${getString(R.string.add_to_cart)} (${Utils.formatPrice(requireContext(), amount)})"
    ...
    private fun showConfirmationDialogForBelowMin(progress: Int) {
        ...
        bundle.putString(io.qurani.android.manager.App.TITLE, getString(R.string.price_change))
        bundle.putString(io.qurani.android.manager.App.TEXT, getString(R.string.price_below_min))
