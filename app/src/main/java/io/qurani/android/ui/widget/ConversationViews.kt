...
class ConversationViews {
    ...
    class AttachmentItem<T>(
        ...
        override fun onClick(v: View?) {
            ...
            val path =
                io.qurani.android.manager.App.Companion.Directory.TICKETS_ATTACHMENT.value() + File.separator + Utils.extractFileNameFromUrl(
                    fileUrl!!
                )
            ...
            if (attachment.exists()) {
                ...
                val bundle = Bundle()
                bundle.putString(io.qurani.android.manager.App.URL, fileUrl)
                bundle.putString(io.qurani.android.manager.App.DIR, io.qurani.android.manager.App.Companion.Directory.TICKETS_ATTACHMENT.value())
