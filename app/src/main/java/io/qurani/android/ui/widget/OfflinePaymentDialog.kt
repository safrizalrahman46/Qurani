...
import io.qurani.android.databinding.DialogOfflinePaymentDetailsBinding
...
import io.qurani.android.presenterImpl.OfflinePaymentDialogPresenterImpl
import io.qurani.android.ui.MainActivity
import io.qurani.android.ui.frag.BanksInfoFrag
import java.util.*

class OfflinePaymentDialog : io.qurani.android.manager.net.observer.NetworkObserverBottomSheetDialog(), View.OnClickListener,
    ...
    private fun init() {
        ...
        val amount = requireArguments().getString(io.qurani.android.manager.App.AMOUNT)
        ...
        val adapter = ItemSpinnerAdapter(requireContext(), io.qurani.android.manager.App.appConfig.offLineBankAccounts)
    ...
    fun onOfflinePaymentSaved(response: io.qurani.android.model.BaseResponse) {
