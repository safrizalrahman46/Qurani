...
import io.qurani.android.databinding.FragSettingsBinding
...
import io.qurani.android.presenterImpl.SettingsPresenterImpl
...
//                    profilePhoto.profileImage = mEncodedImg!!
                    mPresenter.uploadPhoto(io.qurani.android.manager.UriToPath.getPath(requireContext(), uri))
                }
            }
    }
    ...
    private fun initUserInfo() {
        val selectFinancialTab = arguments != null && requireArguments().getBoolean(io.qurani.android.manager.App.FINANCIAL)
    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            ...
            R.id.settingsSaveBtn -> {
                val viewPager = mBinding.settingsUserViewPager
                val viewPagerAdapter = viewPager.adapter as io.qurani.android.manager.adapter.ViewPagerAdapter
    ...
    fun onProfileSaved(response: io.qurani.android.model.BaseResponse) {
